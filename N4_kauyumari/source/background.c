...
int background_w_fld(
  ...
  *w_fld = pba->b4_fld + (pba->b3_fld - 4.*pba->b4_fld)*a + (pba->b2_fld - 3.*pba->b3_fld + 6.*pba->b4_fld)*pow(a,2.) + (pba->b1_fld - 2.*pba->b2_fld + 3.*pba->b3_fld - 4.*pba->b4_fld)*pow(a,3.) + (pba->b0_fld - pba->b1_fld + pba->b2_fld - pba->b3_fld + pba->b4_fld)*pow(a,4.);
/**************************************************************************************************************************/
...
/**************************************************************************************************************************/
  ...
  *dw_over_da_fld = (pba->b3_fld - 4.*pba->b4_fld) + 2.*(pba->b2_fld - 3.*pba->b3_fld + 6.*pba->b4_fld)*a + 3.*(pba->b1_fld - 2.*pba->b2_fld + 3.*pba->b3_fld - 4.*pba->b4_fld)*pow(a,2.) + 4.*(pba->b0_fld - pba->b1_fld + pba->b2_fld - pba->b3_fld + pba->b4_fld)*pow(a,3.);
  ...
  *integral_fld = 3.*((pba->b3_fld - 4.*pba->b4_fld)*(1.-a) + 0.5*(pba->b2_fld - 3.*pba->b3_fld + 6.*pba->b4_fld)*(1.-pow(a,2.)) + (1./3.)*(pba->b1_fld - 2.*pba->b2_fld + 3.*pba->b3_fld - 4.*pba->b4_fld)*(1.-pow(a,3.)) + (1./4.)*(pba->b0_fld - pba->b1_fld + pba->b2_fld - pba->b3_fld + pba->b4_fld)*(1.-pow(a,4.)) - log(a)*(1+pba->b4_fld));
