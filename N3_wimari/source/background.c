...
int background_w_fld(
  ...
  *w_fld = pba->b3_fld + (pba->b2_fld - 3.*pba->b3_fld)*a + (pba->b1_fld - 2.*pba->b2_fld + 3.*pba->b3_fld)*pow(a,2.) + (pba->b0_fld - pba->b1_fld + pba->b2_fld - pba->b3_fld)*pow(a,3.);
/**************************************************************************************************************************/
...
/**************************************************************************************************************************/
  ...
  *dw_over_da_fld = (pba->b2_fld - (3.*pba->b3_fld)) + 2.*(pba->b1_fld - (2.*pba->b2_fld) + (3.*pba->b3_fld))*a + 3.*(pba->b0_fld - pba->b1_fld + pba->b2_fld - pba->b3_fld)*pow(a,2.);
